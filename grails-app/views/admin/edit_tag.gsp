	...
	<body>
		...
		<div id="edit-tag" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<fieldset class="form">
					<g:render template="form_tag"/>
				</fieldset>
				<fieldset class="buttons">
					<g:actionSubmit class="save" action="update_tag" value="${message(code: 'default.button.update.label', default: 'Update')}" />
					<g:actionSubmit class="delete" action="delete_tag" value="${message(code: 'default.button.delete.label', default: 'Delete')}" formnovalidate="" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
