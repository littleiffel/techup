...
<body>
	<h1>Browse Events By Tag: <span class="tag-title">${tagInstance?.getName()}</span>&thinsp;<g:link controller="tag" action="feed" id="${tagInstance?.getName()}"><img src="${resource( dir:'images', file:'feed.png')}" /></g:link></h1>
	<div class="tabbable">
